...
proc mcp.incoming event {
    ...
    if { $mcp_use == 0 } { return [modules.module_deferred] }
...
proc mcp.callback {} {
    ...
    ttk::checkbutton $c.buttons.usemcp \
        -text "use mcp" \
        -variable mcp_use

    ttk::checkbutton $c.buttons.mcpactive \
        -text "mcp active" \
        -variable mcp_active

    ttk::checkbutton $c.buttons.uselog \
        -text "log mcp" \
